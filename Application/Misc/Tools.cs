...
public class Tools 
{
    ...
    //    level.CardName = doc.SelectSingleNode("/Level/CardName").InnerText;
    ...
    //    XmlNodeList nodes;
    //    nodes = doc.SelectNodes("/Level/Towers/TowerID");
    //    for (int i = 0; i < nodes.Count; i++)
    //    {
    //        XmlNode node = nodes[i];
    //        int n = int.Parse(node.InnerText);
    //        level.Towers.Add(n);
    //    }
    ...
    //    sb.AppendLine(string.Format("<CardName>{0}</CardName>", level.CardName));
    ...
    //    {
    //        sb.AppendLine(string.Format("<TowerID>{0}</TowerID>", level.Towers[i]));
    //    }
    //    sb.AppendLine("</Towers>");
