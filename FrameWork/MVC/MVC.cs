...
public static class MVC
{
   ...
   public static void RegisterController(string eventName, Type controllerType)
    ...
    public static void SendEvent(string eventName, string viewName, object data = null)
    {
       if (Views.ContainsKey(viewName))
        {
            if(Views[viewName].AttationEvents.Contains(eventName))
                 Views[viewName].HandleEvent(eventName, data);
        }
    }
}
